...
QString AccumulatorModel::portCaption(QtNodes::PortType portType, QtNodes::PortIndex) const
{
...
void AccumulatorModel::setInData(std::vector<std::shared_ptr<QtNodes::NodeData>> data, QtNodes::PortIndex)
{
    _input.clear();
