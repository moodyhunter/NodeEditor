...
bool MaxModel::hasDynamicPorts(QtNodes::PortType portType) const
{
    if (portType == PortType::In)
        return true;
...
QtNodes::NodeDataType MaxModel::dataType(QtNodes::PortType, QtNodes::PortIndex) const
{
    return DecimalData().type();
}

std::shared_ptr<QtNodes::NodeData> MaxModel::outData(QtNodes::PortIndex)
{
    return _result;
}

void MaxModel::setInData(std::shared_ptr<QtNodes::NodeData> data, QtNodes::PortIndex portIndex)
{
...
QString MaxModel::caption() const
{
    return QStringLiteral("Max");
}

bool MaxModel::portCaptionVisible(QtNodes::PortType, QtNodes::PortIndex) const
{
    return true;
}

QString MaxModel::portCaption(QtNodes::PortType portType, QtNodes::PortIndex) const
{
    switch (portType)
    {
...
QString MaxModel::name() const
{
    return QStringLiteral("Max");
}

QtNodes::NodeValidationState MaxModel::validationState() const
{
