...
NumberSourceDataModel::NumberSourceDataModel() : _number(std::make_shared<DecimalData>()), _lineEdit(nullptr)
{
}
...
void NumberSourceDataModel::onTextEdited(QString const &)
{
    bool ok = false;
