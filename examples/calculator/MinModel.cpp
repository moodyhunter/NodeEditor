...
bool MinModel::hasDynamicPorts(QtNodes::PortType portType) const
{
    if (portType == PortType::In)
        return true;
...
QtNodes::NodeDataType MinModel::dataType(QtNodes::PortType, QtNodes::PortIndex) const
{
    return DecimalData().type();
}

std::shared_ptr<QtNodes::NodeData> MinModel::outData(QtNodes::PortIndex)
{
    return _result;
}

void MinModel::setInData(std::shared_ptr<QtNodes::NodeData> data, QtNodes::PortIndex portIndex)
{
...
QString MinModel::caption() const
{
    return QStringLiteral("Min");
}

bool MinModel::portCaptionVisible(QtNodes::PortType, QtNodes::PortIndex) const
{
    return true;
}

QString MinModel::portCaption(QtNodes::PortType portType, QtNodes::PortIndex) const
{
    switch (portType)
    {
        case PortType::In: return QStringLiteral("Decimal");
...
QString MinModel::name() const
{
    return QStringLiteral("Min");
}

QtNodes::NodeValidationState MinModel::validationState() const
{
...
void MinModel::restore(const QJsonObject &obj)
{
