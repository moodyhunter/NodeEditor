...
ImageShowModel::ImageShowModel() : _label(nullptr)
{
}

unsigned int ImageShowModel::nPorts(PortType) const
{
    return 1;
}
...
QWidget *ImageShowModel::embeddedWidget()
{
    if (!_label)
    {
        ...
        connect(this, &ImageShowModel::updateLabel, _label, [this](const QPixmap &pix) { _label->setPixmap(pix); });
    }
    return _label;
}
